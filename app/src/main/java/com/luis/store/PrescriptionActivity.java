...
//        layParams.rightMargin = Utils.dipToPixels(getActContext(), 15);
        ...
        Picasso.get()
                .load(Utilities.getResizeImgURL(getActContext(), listData.get(position), ((int) Utils.getScreenPixelWidth(getActContext())) - Utils.dipToPixels(getActContext(), 30), 0, Utils.getScreenPixelHeight(getActContext()) - Utils.dipToPixels(getActContext(), 30)))
