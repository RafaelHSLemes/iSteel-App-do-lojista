    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (deriverImage != null && !deriverImage.equals("")) {
            ...
            if (type!=null && type.equalsIgnoreCase("Driver")) {
                deriverImage = CommonUtilities.SERVER_URL_PHOTOS + "upload/Driver/" + Id + "/" + deriverImage;
            } else {
                deriverImage = CommonUtilities.SERVER_URL_PHOTOS + "upload/Passenger/" + Id + "/" + deriverImage;
            }
