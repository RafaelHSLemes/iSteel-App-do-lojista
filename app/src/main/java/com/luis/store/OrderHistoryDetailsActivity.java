        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            if (responseObj != null && !responseObj.equals("")) {
                ...
                if (isDataAvail == true) {
                    ...
                    deliverystatusTxt.setText(AppFunctions.fromHtml(generalFunc.getJsonValueStr("vStatusNew", messageObj)));
...
*/
                    if (generalFunc.getJsonValueStr("iStatusCode", messageObj).equalsIgnoreCase("6") && generalFunc.getJsonValueStr("ePaid", messageObj).equals("Yes")) {
                        ...
                        deliverystatusTxt.setText(AppFunctions.fromHtml(generalFunc.getJsonValueStr("OrderStatusValue", messageObj)));
