...
//    }
        ...
        new SlideDateTimePicker.Builder(getSupportFragmentManager())
                .setListener(new SlideDateTimeListener() {
                    ...
                    public void onDateTimeSet(Date date) {
                        ...
                        expBoxTXT.setText(Utils.convertDateToFormat("yyyy-MM-dd", date));
                    }
    ...
    private void ShowProgressUpdateDialog(int progress) {
        if (openprogressDialog == null) {
            Log.d(TAG, "onProgressUpdate: " + "dialognull");
            openprogressDialog = new OpenProgressUpdateDialog(getActContext(), generalFunc, uploadProfileImage);
            openprogressDialog.run();
        }
        openprogressDialog.updateProgress(progress);

    }

    private static final String TAG = "UploadDocActivity";
