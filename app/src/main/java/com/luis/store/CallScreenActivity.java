...
public class CallScreenActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new CreateRoundedView(backColor, btnRadius, 2,
                strokeColor, btn_speaker);
        new CreateRoundedView(backColor, btnRadius, 2,
                strokeColor, btn_mute);
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == btn_mute.getId()) {
                ...
                if (ismute) {
                    ...
                    btn_mute.setColorFilter(getActContext().getResources().getColor(R.color.black));
                }
                ...
                if (isSpeaker) {
                    ...
                    isSpeaker = true;
                    new CreateRoundedView(strokeColor, btnRadius, 2,
                            backColor, btn_speaker);
                    getSinchServiceInterface().getSinchClient().getAudioController().enableSpeaker();
                    btn_speaker.setColorFilter(getActContext().getResources().getColor(R.color.black));
                }
