...
public class OrderDetailActivity extends BaseActivity implements OrderItemsRecyclerAdapter.OnItemClickList {
    ...
    MTextView totalItemsTxt, responsavel, endereco;
...
//        setChargeDetails();
    ...
    private void initView() {
        ...
        responsavel = (MTextView) findViewById(R.id.responsavel);
        endereco = (MTextView) findViewById(R.id.endereco);
        titleTxt = (MTextView) findViewById(R.id.titleTxt);
...
/*
    ...
    public void marcarComoEntregue() {
        ...
        parameters.put("type", "marcarComoEntregue");
        parameters.put("iCompanyId", generalFunc.getMemberId());
        parameters.put("iOrderId", orderData.get("iOrderId"));
        parameters.put("eUserType", Utils.app_type);
            ...
            if (responseObj != null && !responseObj.equals("")) {
                ...
                if (isDataAvail == false) {
                    ...
                    if (message.equals("NO_CARS")) {
                        ...
                        generateAlert.setCancelable(false);
                        // Finalizar pedido sem motorista
                        // BruninhoGeek
                        // Massoni App
                        ...
                        generateAlert.setContentMessage("Entregadores indisponíveis!", "Todos os entregadores estão ocupados no momento.");
                        generateAlert.setNegativeBtn("Cancelar pedido");
                        generateAlert.setPositiveBtn("Tentar novamente depois");
            ...
            if (responseObj != null && !responseObj.equals("")) {
                ...
                if (isDataAvail) {
                    ...
                    if (assignStatus.equalsIgnoreCase("REQ_NOT_FOUND")) {
                        ...
                        if (eConfirm.equalsIgnoreCase("Yes")) {
    ...
    public class setOnClickList implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (view.getId() == declineBtn.getId() || view.getId() == declineAssignBtn.getId()) {
                ...
                generalFunc.showGeneralMessage("", generalFunc.retrieveLangLBl("Are you sure, you want to confirm order? After confirming order you will not be able to change items' availability.", "LBL_CONFIRM_ORDER_ALERT"), generalFunc.retrieveLangLBl("", "LBL_CANCEL_TXT"), generalFunc.retrieveLangLBl("", "LBL_CONTINUE_TXT"), buttonId -> {
                    if (buttonId == 1) {
                        confirmOrder();
                    }
                });
