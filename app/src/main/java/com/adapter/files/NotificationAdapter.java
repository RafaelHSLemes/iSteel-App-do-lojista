...
public class NotificationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        String vTitle=itemData.get("vTitle");
        ...
        String tDescription=itemData.get("tDescription");
        ...
        String dDateTime=itemData.get("dDateTime");
        if (dDateTime != null && !dDateTime.equalsIgnoreCase("")) {
            viewHolder.dateTxt.setText(dDateTime);
        }

        viewHolder.readMoreTxt.setText(itemData.get("readMoreLbl"));
