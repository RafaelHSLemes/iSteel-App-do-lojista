...
import com.luis.store.BuildConfig;
...
//    }
    ...
    public void execute() {
        ...
        if (isLoaderShown == true) {
            myPDialog = new MyProgressDialog(mContext, false, generalFunc.retrieveLangLBl("Loading", "LBL_LOADING_TXT"));
//            isSetCancelable = true;
        ...
        if (parameters != null) {
            ...
            parameters.put("iServiceId", parameters.get("iServiceId") == null ? generalFunc.getServiceId() : parameters.get("iServiceId"));
